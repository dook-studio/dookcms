...
public partial class Crm_ArticleList : BaseCrm
{
    public int fid = 0;
    ...
    private void BindData(string strwhere)
    {
        int total = 0;
        int pagecount = 1;
        gvList.DataSource = BLL.DataBaseHelper.instance.GetList("article", "[id]", "[id],[flag], [title], [picurl], [typeid], [isshow], [click], [addtime]", pager.PageSize, pager.CurrentPageIndex, strwhere, "id desc", out total, out pagecount);
        gvList.DataBind();
    ...
    protected void btnMove_Click(object sender, EventArgs e)
    {
        ...
        foreach (string item in ids)
        {
            ...
            hs.Add("typeid", catid);
            BLL.DataBaseHelper.instance.Update(hs, "article", "id=" + item);
        }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            Hashtable hs = new Hashtable();
            BLL.DataBaseHelper.instance.Delete("article", "id=" + item);
        }
        lbltips.Text = "操作成功! " + DateTime.Now.ToString("mm:ss");
        BindData(strwhere);
    }
    ...
    {
        DataBaseHelper.instance.ResetTable("article");
        BindData(strwhere);      
    }
}
