...
public partial class Crm_dictionarypoplist : BaseCrm
{
    public string pname = "", depth = "", strwhere = " 1=1 ";
    public int fid = 0;
    public List<Dictionary> list= StringHelper.DataTableToList<Dictionary>(BLL.DataBaseHelper.instance.GetList("dictionary").Tables[0]);
    ...
    private void BindData(string strwhere)
    {
        int total = 0;
        int pagecount = 1;
        DataSet ds = BLL.DataBaseHelper.instance.GetList("dictionary", "[id]", "*", pager.PageSize, pager.CurrentPageIndex, strwhere, "px", out total, out pagecount); ;
    ...
    {        
        ...
        hs.Add("px", px);
        BLL.DataBaseHelper.instance.Insert(hs, "dictionary");
        BindData(strwhere);
    }
    ...
    protected void gvList_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        hs.Add("pid", pid);
        hs.Add("px", px);
        BLL.DataBaseHelper.instance.Update(hs, "dictionary", "id=" + id);
    ...
    protected void gvList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            BLL.DataBaseHelper.instance.Delete("dictionary", "id=" + id);
            BindData(strwhere);
        }
    ...
    public string GetNavLink(int id)
    {
        if (list != null)
        {
            ...
            {
                str = string.Format("<a class=\"nav\" href='poplist.aspx?pid={0}&pname={1}'>{1}</a>&gt;&gt;", model.id, model.keytext) + str;
                return str.ToString();
            }
