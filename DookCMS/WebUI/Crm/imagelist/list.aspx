...
<asp:Content ID="Content2" ContentPlaceHolderID="cbody" runat="Server">
    <div class="nav" style="padding: 5px;">
        当前位置：<a style="color: #fff;" href="list.aspx">图集列表</a> ＞</div>
    <div style="margin-bottom: 5px;">
        <asp:Button ID="btnAddNew" runat="server" Text="添加图集" OnClick="btnAddNew_Click" />
        ...
        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="标题">
                    <ItemTemplate>
                        <a href="/imgitem.ashx?aid=<%#Eval("id") %>" target="_blank">
                ...
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <a href="edit.aspx?id=<%#Eval("id") %>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a style="cursor: pointer;"
                            data-tag="<%#Eval("id") %>">推送</a>
    ...
    <div>
        <span style="float: left; margin-top: 15px;">共<%=pager.RecordCount %>条 当前:<%=pager.CurrentPageIndex %>/<%=pager.PageCount %>页</span>
    ...
    <div style="background-color: #ddd; border: solid 1px #666; padding: 5px;">
        ...
        <input id="btnselall" type="button" value="全选" /><input id="btnnosel" type="button"
            value="反选" /><asp:Button ID="btnDelete" runat="server" Text="删除所选" OnClick="btnDelete_Click" />
