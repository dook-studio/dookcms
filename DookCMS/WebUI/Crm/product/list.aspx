...
<asp:Content ID="Content2" ContentPlaceHolderID="cbody" runat="Server">
    <div class="nav" style="padding: 5px;">
        当前位置：<a style="color: #fff;" href="list.aspx">商品列表</a> ＞</div>
    <div style="margin-bottom: 5px;">
        <asp:Button ID="btnAddNew" runat="server" Text="添加商品" OnClick="btnAddNew_Click" />
    ...
    <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="标题">
                <ItemTemplate>
                    <a href="/pitem.ashx?aid=<%#Eval("id") %>" target="_blank">
            ...
            <asp:BoundField DataField="mprice" HeaderText="市场价" SortExpression="mprice" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="price" HeaderText="优惠价" SortExpression="price" ItemStyle-HorizontalAlign="Center" />
