...
public partial class Crm_ProductList : BaseCrm
{ 
    public int fid = 0;
    string strwhere = "1=1 ";
    ...
    private void BindData(string strwhere)
    {
        int total = 0;
        int pagecount = 1;
        gvList.DataSource = BLL.DataBaseHelper.instance.GetList("product", "[id]", "[id],[catid],[flag], [title], [mprice],[price],[typeid],[picurl], isshow,[total], [click], [addtime]", pager.PageSize, pager.CurrentPageIndex, strwhere, "id desc", out total, out pagecount);
        gvList.DataBind();
    ...
    {
        BLL.DataBaseHelper.instance.ResetTable("product");
        BindData(strwhere);
    ...
    protected void btnMove_Click(object sender, EventArgs e)
    {
        ...
        foreach (string item in ids)
        {
            ...
            hs.Add("typeid", catid);
            BLL.DataBaseHelper.instance.Update(hs, "product", "id=" + item);
        }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            Hashtable hs = new Hashtable();
            BLL.DataBaseHelper.instance.Delete("product", "id=" + item);
        }
        lbltips.Text = "操作成功! " + DateTime.Now.ToString("mm:ss");
        BindData(strwhere);
    }
