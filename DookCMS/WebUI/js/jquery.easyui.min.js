...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"请填写此项.",invalidMessage:null,rules:{email:{validator:function(_2fa){
...
},message:"请输入正确的电子邮件格式."},url:{validator:function(_2fb){
