<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditColumn.aspx.cs" Inherits="Mdbw_EditColumn"
    ...
    <div>
        <table class="tblist" style="width: 500px; text-align: left">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:DropDownList ID="dropType" runat="server" >
                        <asp:ListItem Value="integer">自动编号</asp:ListItem>
                        <asp:ListItem Value="nvarchar" Selected="True">文本</asp:ListItem>                        
                        <asp:ListItem Value="integer">数字</asp:ListItem>
                        <asp:ListItem Value="text">备注</asp:ListItem>
                        <asp:ListItem Value="datetime">日期</asp:ListItem>
                        <asp:ListItem Value="bit">是/否</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr id="trLength" runat="server">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtLength" Width="100px" CssClass="inputtxt" MaxLength="3" Text="0" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 100px">
            ...
            <tr id="trDefaultValue" runat="server">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtDefaultValue" Width="100px" CssClass="inputtxt" 
                        runat="server"></asp:TextBox>
                </td>
            </tr>
            <%-- <tr>
